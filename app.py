...
def process_sheets(xls1, s1, xls2, s2, col1, col2, matches_100, matches_75_99, matches_50_74):
    ...
    if col1 in df1.columns and col2 in df2.columns:
        # Pre-convert to list of records for faster iteration
        ...
        # Optimization: Cache fuzzy scores between unique normalized values
        fuzz_results_cache = {}
        ...
        for idx1, row1 in enumerate(records1):
            ...
            # 2. Fuzzy Match (Loop over unique normalized values)
