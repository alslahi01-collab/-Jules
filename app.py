...
def process_sheets(xls1, s1, xls2, s2, col1, col2, matches_100, matches_75_99, matches_50_74):
    ...
    if col1 in df1.columns and col2 in df2.columns:
        # Pre-calculate normalized values for df2 and group them
        df2_norm_map = {}
        df2_unique_norms = []
        for idx2, row2 in df2.iterrows():
            ...
            if norm2 not in df2_norm_map:
                df2_norm_map[norm2] = []
                df2_unique_norms.append(norm2)
            df2_norm_map[norm2].append((idx2, row2))
        ...
        for idx1, row1 in df1.iterrows():
            ...
            if norm1 in df2_norm_map:
                for idx2, row2 in df2_norm_map[norm1]:
            ...
            for norm2 in df2_unique_norms:
                ...
                if score >= 50:
                    for idx2, row2 in df2_norm_map[norm2]:
                        match_row = row1.to_dict()
