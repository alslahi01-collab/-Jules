...
def process_sheets(xls1, s1, xls2, s2, col1, col2, matches_100, matches_75_99, matches_50_74):
    ...
    if col1 in df1.columns and col2 in df2.columns:
        ...
        # This reduces O(N*M) complexity to O(U1*U2) where U is unique values
        ...
        for idx1, row1 in enumerate(records1):
            ...
            # 2. Check for fuzzy matches among OTHER unique values
            for norm2 in unique_norms2:
                if norm1 == norm2: continue # Already handled in matches_100
                
                # Symmetric cache for fuzz.ratio to avoid redundant calculations
