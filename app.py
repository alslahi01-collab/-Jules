    ...
    if col1 in df1.columns and col2 in df2.columns:
        ...
        for norm1 in unique_norms1:
            ...
            for norm2 in unique_norms2:
                ...
                # Check symmetric cache to avoid redundant calculations
                ...
                if score >= 75:
                    for idx1, row1 in groups1[norm1]:
                        for idx2, row2 in groups2[norm2]:
                            match_row = row1.copy()
