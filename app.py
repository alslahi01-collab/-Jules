...
def process_sheets(xls1, s1, xls2, s2, col1, col2, matches_100, matches_75_99, matches_50_74):
    ...
    if col1 in df1.columns and col2 in df2.columns:
        ...
        # Pre-calculate normalized values for df2 and group by value
        norm_map2 = {}
        ...
        for idx1, row1 in enumerate(records1):
            ...
            # 1. Check for exact matches first (100% similarity)
            ...
            # 2. Check for fuzzy matches with all other unique values in df2
            for n2 in unique_norms2:
                if norm1 == n2: continue # Skip exact matches (already handled)
                
                # Use a sorted tuple as cache key to leverage symmetry of fuzz.ratio
