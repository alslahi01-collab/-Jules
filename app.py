...
def process_sheets(xls1, s1, xls2, s2, col1, col2, matches_100, matches_75_99, matches_50_74):
    ...
    if col1 in df1.columns and col2 in df2.columns:
        ...
        # Group indices by normalized value to reduce redundant fuzzy matching
        norm_map1 = {}
        ...
        # Cache fuzzy results between unique string pairs
        fuzz_results_cache = {}
        ...
        for norm1, indices1 in norm_map1.items():
            for norm2, indices2 in norm_map2.items():
                ...
                # Use sorted tuple as key to handle symmetry if we were doing all-vs-all,
                # but here it's ordered comparison.
                pair = (norm1, norm2)
