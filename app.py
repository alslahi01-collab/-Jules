...
def process_sheets(xls1, s1, xls2, s2, col1, col2, matches_100, matches_75_99, matches_50_74):
    ...
    if col1 in df1.columns and col2 in df2.columns:
        # Convert to records for faster iteration and access
        records1 = df1.to_dict('records')
        records2 = df2.to_dict('records')

        # Group indices by normalized values to reduce comparisons
        norm_map1 = {}
        ...
        # Cache for fuzzy scores to avoid redundant calculations between unique strings
        fuzzy_cache = {}

        # Iterate over unique normalized values
        for n1, indices1 in norm_map1.items():
            for n2, indices2 in norm_map2.items():
                ...
                # Check fuzzy match for unique pairs
