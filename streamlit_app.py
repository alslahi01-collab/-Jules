...
def process_comparison(file1, file2, col1, col2):
    ...
    # Pre-process sheets of file2 once to avoid re-reading in nested loop
    processed_sheets2 = []
    for s2 in sheets2:
        ...
        if col2 in df2.columns:
            ...
            processed_sheets2.append({'name': s2, 'header': h2, 'records': records2, 'norm_map': norm_map2})
    ...
    for s1 in sheets1:
        ...
        for s2_info in processed_sheets2:
            s2 = s2_info['name']
            h2 = s2_info['header']
