...
def process_comparison(file1, file2, col1, col2):
    ...
    # Pre-read and pre-process all sheets from file2 to avoid redundant I/O and processing
    prepared_sheets2 = []
    for s2 in sheets2:
    ...
    # Cache for fuzzy match results between unique strings
    fuzz_results_cache = {}
    ...
    for s1 in sheets1:
        ...
        for sheet2_data in prepared_sheets2:
            s2 = sheet2_data['name']
            h2 = sheet2_data['header_idx']
            records2 = sheet2_data['records']
            norm_map2 = sheet2_data['norm_map']
