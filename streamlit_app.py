...
def process_comparison(file1, file2, col1, col2):
    ...
    # Pre-read and process all sheets from file2 to avoid redundant I/O in the nested loop
    processed_sheets2 = []
    for s2 in sheets2:
        ...
        if col2 in df2.columns:
            processed_sheets2.append((s2, df2, h2))
    ...
    for s1 in sheets1:
        ...
        for s2, df2, h2 in processed_sheets2:
