...
def process_comparison(file1, file2, col1, col2):
    ...
    # Optimization: Pre-load and pre-process target file sheets
    target_sheets_data = []
    for s2 in sheets2:
    ...
    for s1 in sheets1:
        ...
        for sheet2_data in target_sheets_data:
            s2 = sheet2_data['name']
            h2 = sheet2_data['header_idx']
            records2 = sheet2_data['records']
            groups2 = sheet2_data['groups']
