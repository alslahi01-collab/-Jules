...
def process_comparison(file1, file2, col1, col2):
    ...
    # Optimization: Pre-read all sheets of the target file to avoid redundant I/O
    processed_sheets2 = []
    for s2 in sheets2:
        ...
        if col2 in df2.columns:
            ...
            # Group indices by normalized value
            norm_map2 = {}
    ...
    for s1 in sheets1:
        ...
        for p2 in processed_sheets2:
            s2 = p2['name']
            h2 = p2['header_row']
            records2 = p2['records']
            norm_map2 = p2['norm_map']
