...
def process_comparison(file1, file2, col1, col2):
    ...
    # Pre-process sheets from file2 into memory to avoid redundant I/O
    processed_sheets2 = []
    for s2 in sheets2:
        ...
        if col2 in df2.columns:
            ...
            for i, rec in enumerate(records2):
                ...
                if norm and norm != 'nan':
                    groups2.setdefault(norm, []).append(i)
    ...
    for s1 in sheets1:
        ...
        for i, rec in enumerate(records1):
            ...
            if norm and norm != 'nan':
                groups1.setdefault(norm, []).append(i)

        for s2_data in processed_sheets2:
            s2 = s2_data['name']
            h2 = s2_data['header_idx']
            records2 = s2_data['records']
            groups2 = s2_data['groups']
